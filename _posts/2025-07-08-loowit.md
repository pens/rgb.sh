...
In my case, this was a 6U 104HP enclosure.
...
In this way, Loowit is really a *modular, modular synth enclosure*.
...
{% include svg src="blog/loowit/sketch1.svg" cap="Drawings working through how rows would rotate relative to one another, and how to place their axes of rotation." %}
...
I think it's unlikely I iterate on this design further, as the current one works great and I don't need more than 504 HP of Eurorack.
