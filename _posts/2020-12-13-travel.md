...
{% include img alt="Coconut" src="coconut.jpg" cap="Coconut on the beach in Bali, Indonesia" %}
...
{% include img alt="Palm" src="palm.jpg" cap="Traveler's Palm in a temple in Bangkok, Thailand" %}
...
{% include img alt="Smoke" src="smoke.jpg" cap="Incense in a temple in Chiang Mai, Thailand" %}
...
{% include img alt="Scooters" src="scooters.jpg" cap="Scooters on Ko Lanta Yai, Thailand" %}
