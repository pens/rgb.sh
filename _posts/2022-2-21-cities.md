...
{% include image.html alt="Element Comparison" src="element_comparison.png" cap="On the left, Pittock Mansion is represented by a **way*" %}.
...
{% include image.html alt="Bounds" src="bounds.png" cap="Without removing bodies of water, we'd end up with maps of the **legal*" %} boundaries of cities.
