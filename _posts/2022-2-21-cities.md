...
{% include image.html alt="Element Comparison" src="/assets/blog/cities/element_comparison.png" cap="On the left, Pittock Mansion is represented by a **way*" %}.
On the right, the viewpoint is represented by a **node**.*
...
{% include image.html alt="All Elements" src="/assets/blog/cities/all_elements.png" cap="This shows all elements in Portland with tags I deemed points of interest." %}
...
{% include image.html alt="Bounds" src="/assets/blog/cities/bounds.png" cap="Without removing bodies of water, we'd end up with maps of the **legal*" %} boundaries of cities.
These are much harder to recognize.*
...
{% include image.html alt="Seattle" src="/assets/blog/cities/seattle.svg" cap="Seattle" %}

{% include image.html alt="Portland" src="/assets/blog/cities/portland.svg" cap="Portland" %}

{% include image.html alt="San Francisco" src="/assets/blog/cities/san_francisco.svg" cap="San Francisco" %}
