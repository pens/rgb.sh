...
![Element Comparison](/assets/blog/cities/element_comparison.png)
*On the left, Pittock Mansion is represented by a **way**.
...
![All Elements](/assets/blog/cities/all_elements.png)
*This shows all elements in Portland with tags I deemed points of interest.*
...
![Bounds](/assets/blog/cities/bounds.png)
*Without removing bodies of water, we'd end up with maps of the **legal** boundaries of cities.
...
![Seattle](/assets/blog/cities/seattle.svg)
*Seattle*

![Portland](/assets/blog/cities/portland.svg)
*Portland*

![San Francisco](/assets/blog/cities/san_francisco.svg)
*San Francisco*
